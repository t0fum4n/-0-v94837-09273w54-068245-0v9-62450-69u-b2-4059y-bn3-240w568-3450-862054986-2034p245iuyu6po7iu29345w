...
$dsdfaaaa = '0-'
$r70 = '-40ehjf84we9f3k'
$adiuhaihvdiuhbweffiuhgbqawerfgoiugh234987 = $ghjk + $erty + $234fg + $bannana + $iwuey86 + $sdfr5 + $dfer + $qwdf + $popi + $butter + $ghi + $rpo + $elt + $opty + $bye + $rtp + $2349807vhj + $345dfgw32445 + $asdf234ss + $1233xxx + $dsdfaaaa + $234234ssss + $qqw233 + $nbwswqe + $vcrdvd + $fdavv + $234sfwser + $werwer + $asdfwwwqqbnsdefot2134 + $tuisyt + $vakjgbg + $eabrfasd + $r33 + $r34 + $r35 + $r36 + $r37
$p1 = "$env:USERPROFILE"
